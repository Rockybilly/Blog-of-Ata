...
BLOG_AUTHOR = "Ata YARDIMCI"  # (translatable)
BLOG_TITLE = "Blog of Ata"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://atayardimci.me/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://atayardimci.me/"
BLOG_EMAIL = "atayardimci97@hotmail.com"
BLOG_DESCRIPTION = "Experience."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/categories/", "Tags"),
        # ("/rss.xml", "RSS feed"),
        ("/stories/other-things/index.html", "Other Things")
    ),
}
